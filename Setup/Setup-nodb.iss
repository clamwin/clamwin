...
OutputBaseFilename=ClamWin-0.92-L10N-38-nodb
AppPublisher=budtse
...
Name: LanguageSupport\Bulgarian; Description: Bulgarian; Types: full
...
#include "..\locale\ar.iss"
#include "..\locale\bg_BG.iss"
...
begin
	...
	While i < 1 do begin
		...
		// remove last directory from the path (Usually Application Data) on anything prior to Vista
		Tmp := AppData;
		While True do begin
			j := Pos('\', Tmp);
			if j <> 0 then begin
