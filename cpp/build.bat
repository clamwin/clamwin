...
::cl /O1 %DEFINES% %UNICODE% /O1 /FD /EHsc /MT /YX"stdafx.h" /Fp".\Release_Unicode/ExplorerShell.pch" /Fo".\Release_Unicode/" /Fd".\Release_Unicode/" /W3 /c /TP .\ShellExtImpl.cpp .\ShellExt.cpp
::if not "%ERRORLEVEL%"=="0" goto END  
