...
CLOSE_ON_LBUTTON_UP    = 0x0001
CLOSE_ON_MBUTTON_UP    = 0x0002
CLOSE_ON_RBUTTON_UP    = 0x0004
CLOSE_ON_LBUTTON_DOWN  = 0x0008
CLOSE_ON_MBUTTON_DOWN  = 0x0010
CLOSE_ON_RBUTTON_DOWN  = 0x0020
CLOSE_ON_MOUSE_MOVE    = 0x0040
CLOSE_ON_KEYPRESS      = 0x0080
CLOSE_ON_ANYTHING      = CLOSE_ON_MOUSE_MOVE|CLOSE_ON_RBUTTON_DOWN|CLOSE_ON_RBUTTON_DOWN|CLOSE_ON_MBUTTON_DOWN|CLOSE_ON_LBUTTON_DOWN|CLOSE_ON_RBUTTON_UP|CLOSE_ON_MBUTTON_UP|CLOSE_ON_LBUTTON_UP
DELAY_CLOSE            = 0x0100
DELETE_THIS_ON_CLOSE   = 0x0200
SHOW_CLOSE_BUTTON      = 0x0400
SHOW_INNER_SHADOW      = 0x0800
SHOW_TOPMOST           = 0x1000
DISABLE_XP_SHADOW      = 0x2000
DISABLE_FADEIN         = 0x4000
DISABLE_FADEOUT        = 0x8000
DISABLE_FADE           = DISABLE_FADEIN|DISABLE_FADEOUT
...
class BalloonHelp:
    def LaunchBalloon(strTitle, strContent,
                      ptAnchor,
                      szIcon """= IDI_EXCLAMATION""",
                      Options """= unSHOW_CLOSE_BUTTON""",
