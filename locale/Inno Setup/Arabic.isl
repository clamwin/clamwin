...
InvalidPath=يجب أن تدخل مسار كامل مع اسم القرص; مثل:%n%nC:\APP%n
...
FinishedRestartLabel=أترغب بإعادة التشغيل الآن؟ [name] يجب إعادة تشغيل الكمبيوتر  لتثبيت 
...
UninstallStatusLabel=من جهازك [name] الرجاء الانتظار ليتم إلغاء تثبيت
UninstalledAll=من جهازك بنجاح %1 تم إلغاء تثبيت
UninstalledMost= تم إلغاء تثبيت برنامج %%1n%nبعض المكونات لم يمكن إلغائها، يمكن إلغائها يدويا
UninstalledAndNeedsRestart=يجب إعادة تشغيل الكمبيوتر لإتمام عملية إلغاء تثبيت %%1n%nأتعيد تشغيله الآن ؟
